                    ...
                    <div class="col-md-8">
                        <form method="post" action="{{ route('package.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input id="price" name="price"  required type="number" class="form-control" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="courses" class="col-lg-3 col-form-label font-weight-semibold">No Of Courses<span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input id="course" name="number_of_courses"  required type="number" class="form-control" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input id="comission" name="commission_percentage	"  required type="number" class="form-control" >
                                </div>
                            </div>
