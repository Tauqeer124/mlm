        ...
        <div class="card-body">
            <form method="post" action="{{ route('package.update', $package->id) }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input id="comission" name="commission_percentage" required type="number" class="form-control" value="{{ $package->commission_percentage }}">
                    </div>
                </div>
                ...
                <div class="text-right">
                    <button type="submit" class="btn btn-success">Update Package <i class="icon-paperplane ml-2"></i></button>
                </div>
            </form>
        </div>
    </div>
