                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-8">
                                <input id="phone" type="tel" class=class="form-control @error('email') is-invalid @enderror"name="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="Format: 123-456-7890" required>
